...
            }} 
            ...
            <TextField id="outlined-basic" variant="outlined" size="small" type="text" margin="dense"
                 style={{ height: "20", width: "500px"}} name="eventname" value={state.eventname} onChange={handleChange}
                  /> 
            <div>
            <Typography style={{
                   color:"#333333", 
            ...
            <TextField id="outlined-basic" variant="outlined" size="small" type="text" margin="dense"
                 style={{ height: "20", width: "500px"}} name="time" value={state.time} onChange={handleChange}
                  /> 
            </div>           
            ...
            <TextField id="outlined-basic" variant="outlined" size="small" type="date" margin="dense"
                 style={{ height: "20", width: "500px"}} name="date" value={state.date} onChange={handleChange}
                  /> 
            </div>
            ...
            <TextField id="outlined-basic" variant="outlined" size="small" type="text" margin="dense"
                 style={{ height: "20", width: "500px"}} name="location" value={state.location} onChange={handleChange}
                  /> 
            </div>
            ...
            <TextField id="outlined-basic" variant="outlined" size="small" type="text" margin="dense"
                 style={{ height: "20", width: "500px"}} name="hashtag" value={state.hashtag} onChange={handleChange}
                  /> 
            </div>
